...
export const MESSAGES: Record<ResolvedLocale, LocaleMessages> = {
  en: {
    ...
    selectionPositionTitle: "Selection position",
    selectionPositionDetail: "Restore the last successful selection separately for each website and target size.",
    selectionPositionToggleTitle: "Remember selection position",
  ...
  zh_CN: {
    ...
    selectionPositionTitle: "选区位置",
    selectionPositionDetail: "按网站和目标尺寸分别恢复上次成功导出时的选区。",
    selectionPositionToggleTitle: "记住选区位置",
    aboutTitle: "开源项目",
