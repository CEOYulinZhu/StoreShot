# Design System of Chat2File

## 1. Visual Theme & Atmosphere

Chat2File's design system, migrated from Airtable, is a clean, enterprise-friendly experience that communicates "sophisticated simplicity" through a white canvas with deep navy text (`#181d26`) and Chat2File Blue (`#1b61c9`) as the primary interactive accent. The Haas font family (display + text variants) creates a Swiss-precision typography system with positive letter-spacing throughout.

**Key Characteristics:**
- White canvas with deep navy text (`#181d26`)
- Chat2File Blue (`#1b61c9`) as primary CTA and link color
...
- **Chat2File Blue** (`#1b61c9`): CTA buttons, links
...
## 7. Do's and Don'ts
### Do: Use Chat2File Blue for CTAs, Haas with positive tracking, 12px radius buttons
